        ...
        {this.props.coinsLeft > 199 && (
          ...
          >
            ...
            <div className='w-full mb-6'>
              <p className='text-white'>Q. 1</p>
              <label
                className='block tracking-wide text-xl text-white mt-3'
                htmlFor='grid-state'
              >
              ...
              <div className='relative w-full flex flex-wrap mt-4'>
                <div className='pr-3'>
                  <div className='rounded-lg bg-white shadow w-32 h-32 p-4 flex items-center justify-center'>
                    BJP
                  </div>
                </div>
                <div className='px-3'>
            ...
            <div className='w-full mb-6'>
              <label
                className='block tracking-wide text-lg text-white mb-2'
                htmlFor='grid-state'
              >
