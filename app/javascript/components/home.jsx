...
export default class Home extends React.Component {
  ...
  render () {
    ...
    return (
      <div className='p-4 flex flex-col bg-white flex justify-center items-center'>
        <div
          className='m-2 flex flex-col w-full md:w-3/5 justify-center items-center text-center question-card shadow rounded'
          id='profile'
        >
        ...
        <div className='p-2 flex flex-col w-full md:w-3/5 justify-center items-center text-center question-card shadow rounded-lg'>
        ...
        {this.coinsLeft() > 199 && (
          <div className='mt-2 p-2 flex flex-col w-full md:w-3/5 justify-center items-center question-card shadow rounded-lg'>
            {this.props.isCurrentUser && (
              <div>
                {!this.state.showForm && (
        ...
        {this.props.predictions.map((prediction, index) => (
          <div
            key={prediction.id}
            className='mt-3 flex flex-col w-full md:w-3/5 justify-center items-center text-center'
          >
