                    ...
                    <div className="flex flex-col max-w-md w-full mt-10">
                      ...
                      {this.props.predictions.map((prediction, index) => (
                        ...
                        >
                          <div
                            id={"p" + prediction.id}
                            className="bg-white current-standings-card w-full text-white px-3 py-5 md:p-5 shadow rounded-xl"
                          >
                              ...
                              <div className="w-full flex border border-t-0 rounded-b-lg shadow bg-white">
                                ...
                                <div className="w-1/2 border-l">
                                  ...
                                  >
                                    ...
                                    />
                                    <input
                                      className="ext-primary text-xs w-full h-9 cursor-pointer hover:bg-primary-lightest hover:text-primary-dark focus:outline-none"
                                      value="Delete"
                                      type="submit"
                                    />
                                    <input
